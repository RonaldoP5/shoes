...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="product1.php">Converse</a></li>
				<li>|</li>
				<li><a href="football1.php" class="active" style="color:#111;">New Balance</a></li>
				<li>|</li>
				<li><a href="running1.php">Adidas</a></li>
			</ul>
...
while($fetch = $query->fetch_array()) // Perbaikan di sini
{
