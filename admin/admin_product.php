...
<body>
	...
	<br>
		...
		<?php
			if (isset($_POST['add'])) {
				...
				$qty = (int)$_POST['qty']; // Pastikan `qty` adalah angka
				...
				if ($error > 0) {
					...
					// Query untuk tabel `product`
					$query1 = "INSERT INTO product (product_id, product_name, product_price, product_size, product_image, brand, category) 
							   VALUES ('$product_code', '$product_name', '$product_price', '$product_size', '$name', '$brand', '$category')";
			
					$query2 = "INSERT INTO stock (product_id, qty) 
							   VALUES ('$product_code', '$qty')";
			
					$conn->query($query1) or die(mysqli_error($conn));
					$conn->query($query2) or die(mysqli_error($conn));
					...
					if ($category === "basketball") {
						...
						header("Location: admin_product.php"); // Default
					}
				}
			}
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Converse</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">New Balance</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Adidas</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Converse</h2></center></div>
			<br />
