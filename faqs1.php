...
<div id="container">
	...
	<br />
		...
		<div id="content">
			...
			<h4>DO YOU SHIP?</h4>
					<p style="text-indent:60px;">Ya, kami hanya mengrimkan produk melalui Jnt dan Sicepat.</p>
				<hr>
					<h4>DO YOU DELIVER?</h4>
						<p style="text-indent:60px;">Tidak, Kami hanya menawarkan Pengiriman.</p>
				<hr>
					<h4>WHEN WILL I GET MY ORDERS?</h4>
						<p style="text-indent:60px;">Kami akan mengirimkan produk Anda 2-3 hari di sekitar indonesia dan akan memakan waktu 4-7 hari ke seluruh negeri.</p>
				<hr>
					<h4>HOW DO I PAY MY ORDERS?</h4>
					<p style="text-indent:60px;">Untuk sekarang hanya bisa melalui paypal dan akan update kedepan nya.</p>
